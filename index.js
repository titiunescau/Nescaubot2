		...
		try {
			...
			mess = {
				...
				only: {
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo do Nescau. Registre-se para fazer amizade com o bot ✞︎𝙼𝚎𝚕𝚒𝚘𝚍𝚊𝚜✞︎ por meio, \n\nCommand : ${prefix}daftar nome|idade\nExemplo : ${prefix}daftar ✞︎𝙼𝚎𝚕𝚒𝚘𝚍𝚊𝚜✞︎|17\n\n──「 BOT MAN 」──`,
			...
			const ownerNumber = ["559887053394@s.whatsapp.net","559887054394@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"559887053394@s.whatsapp.net","559887053394@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["559887053394@s.whatsapp.net","559887053394@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["559887053394@s.whatsapp.net","559887053394@s.whatsapp.net"]//ubah nomor lo
			const premium = ["55987053394@s.whatsapp.net","559887054394@s.whatsapp.net","559891051582@s.whatsapp.net","]
			...
			switch(command) {
	            ...
	            case 'donosbot':
				    ...
				    try {    
						...
						reply('PQP VEY DEU ERRO AQUI MN')
					}
					break
					case 'lista':
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS ✞︎ Nescau✞︎ BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @✞︎Nescau✞︎ domina vida
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o Nescau ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
					...
					case 'addvip':  
					if (!isOwner) return reply(mess.only.ownerB)
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o ✞︎Nescau✞︎ ou digite * # Daftarvip * para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT ✞︎Nescau✞︎ ✨* 」\n*│+ wa.me/559887053394*╰──────*「 *✞︎Nescau✞︎* 」*────*\n\n*_SE QUER SER ADMIN DO BOT ✞︎Nescau✞︎_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
